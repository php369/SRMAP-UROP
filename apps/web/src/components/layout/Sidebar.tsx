      ...
      <div className="flex items-center justify-center h-16 px-4 border-b border-white/10">
        {isCollapsed ? (
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold text-text">SRM Portal</h1>
          </div>
        )}
      </div>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {isCollapsed && (
                    <div className="absolute left-full ml-2 px-2 py-1 bg-surface border border-border rounded-lg text-xs text-text opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
                      {item.label}
                    </div>
                  )}
                </>
          ...
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            <div 
              ...
              className={cn(
                ...
                isAnimating && !isMobileOpen ? '-translate-x-full' : 'translate-x-0'
              )}
            >
