...
import { BellIcon, XIcon, Maximize2Icon } from '../ui/Icons';
...
export function NotificationBell({ variant = 'default' }: NotificationBellProps) {
    ...
    // Notification List Renderer (Reusable)
    const renderNotificationList = (compact: boolean = false) => (
        <>
    ...
    const popoverContent = (
        <>
            <div className={cn("flex items-center justify-between px-4 py-3", isSidebar ? "" : "border-b border-slate-100")}>
                {!isSidebar && (
                ...
                <div className="flex items-center gap-2 ml-auto">
                    ...
                    {/* Maximize Icon for sidebar variant */}
                    {isSidebar && (
                        <button
                            onClick={() => {
                                setIsOpen(false);
