        ...
        <div className="relative z-20 w-full max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Reveal duration={1.0} delay={0.4} direction="up">
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-20 relative z-30">
              <Link
                to={isAuthenticated ? ROUTES.DASHBOARD : ROUTES.LOGIN}
                className="btn-blob flex items-center justify-center h-14 px-12 rounded-full font-bold text-lg tracking-wide transform transition-transform hover:scale-105 active:scale-95 duration-300 ease-out-quart"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Reveal key={i} delay={i * 0.1} duration={0.8} direction="up" className="h-full">
                <div className="group flex flex-col items-start p-6 rounded-2xl bg-white/50 border border-slate-100 hover:border-srm-200 transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:-translate-y-1 backdrop-blur-sm dark:bg-slate-900/50 dark:border-slate-800 dark:hover:border-srm-900 h-full">
