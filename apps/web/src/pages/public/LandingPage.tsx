  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-srm-100 dark:bg-slate-950 dark:text-slate-100 flex flex-col overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-white/80 via-white/50 to-transparent dark:from-slate-950/80 dark:via-slate-950/50"></div>
      </div>
      ...
      <main className="flex-grow flex flex-col relative w-full pt-12 md:pt-16 z-10">
        <div className="relative z-20 w-full max-w-5xl mx-auto px-6 lg:px-8 text-center">
          ...
          <Reveal duration={1.0} delay={0.4} direction="up" fullWidth>
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-32 relative z-30">
              {/* Glassy Buttons */}
              <Link
                to={isAuthenticated ? ROUTES.DASHBOARD : ROUTES.LOGIN}
        ...
        {/* 3. Features Section & Hero Image Overlap Wrapper */}
        <div className="relative w-full mt-auto">

          {/* Hero Image (Behind Features) */}
          <div className="absolute bottom-0 left-0 w-full h-[800px] z-0 overflow-hidden pointer-events-none">
            <div
              className="w-full h-full bg-cover bg-bottom bg-no-repeat relative"
              style={{
                backgroundImage: 'url(/background.webp)',
                maskImage: 'linear-gradient(to bottom, transparent 0%, transparent 20%, black 100%)',
                WebkitMaskImage: 'linear-gradient(to bottom, transparent 0%, transparent 20%, black 100%)'
              }}
            >
          ...
          {/* Features Section (Overlapping Image) */}
          <section id="features" className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 pb-32">
